...
void main()
{
	...
	do
	{
		...
		case '2':
			...
			for (int i = 0; i < (colichestvo_kvadratov * 10) + 6; i++)
			{
			...
			for (int i = 0; i < colichestvo_kvadratov; i++)
			{
				...
				if (i == colichestvo_kvadratov - 1)cout << (char)polosa_kasaya_naoborot_sverhu << "  " << (char)polosa_vertekalnaya;
			}
			cout << endl;
			for (int i = 0; i < colichestvo_strok; i++)
			{
				for (int i = 0; i < 5; i++)
				{
					if (colichestvo_kvadratov % 2 == 0)
					{
						for (int j = 0; j < colichestvo_kvadratov; j++)
						{
							...
							if (j == colichestvo_kvadratov - 1 && i != 2)cout << (char)polosa_vertekalnaya << "  " << (char)polosa_vertekalnaya;
							else if (j == colichestvo_kvadratov - 1 && i == 2 && numeracia2 < 10)cout << (char)polosa_vertekalnaya << " " << numeracia2 << (char)polosa_vertekalnaya;
							else if (j == colichestvo_kvadratov - 1 && i == 2)cout << (char)polosa_vertekalnaya << numeracia2 << (char)polosa_vertekalnaya;
						}
					}
					else
					{
			...
			for (int i = 0; i < colichestvo_kvadratov; i++)
			{
				...
				if (i == colichestvo_kvadratov - 1)cout << (char)polosa_kasaya_naoborot_snizy <<"  " << (char)polosa_vertekalnaya;
			}
			cout << endl;
			bykva = 65;
			for (int i = 0; i < colichestvo_kvadratov; i++)
